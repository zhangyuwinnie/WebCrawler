...
if __name__ == '__main__':
    ...
    for i in range(len(urlList)):
        print (i)
        url = 'https://clinicaltrials.gov/ct2/show/study' + urlList[i][9:]
        print(url)
        # sheet1.write(i, 0, titleList[i])
        sheet1.write(i, 0, statusList[i])
        sheet1.write(i, 1, conditionList[i])
        sheet1.write(i, 2, interventionList[i])
